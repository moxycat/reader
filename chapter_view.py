...
def make_window():
    layout = [
        [sg.Listbox([], key="details_chapters", size=(90, 15), enable_events=True, bind_return_key=True, change_submits=True, right_click_menu=["", ["Mark as read", "Download"]], select_mode=sg.LISTBOX_SELECT_MODE_EXTENDED)]
    ]
